...
- [**Extensive Model Support**](#built-in-models): WebLLM natively supports a range of models incl<div align="center" id="top">

Your Project Name

Kid-Friendly Language Model Running In Your Browser

✨ Live Demo: Try Your Project Name Now! ✨

[
![alt text](https://img.shields.io/badge/Your%20Badge%201-Value-blue)
](#[link to your badge 1])
[
![alt text](https://img.shields.io/badge/Your%20Badge%202-Value-green)
](#[link to your badge 2])
[
![alt text](https://img.shields.io/badge/Your%20Badge%203-Value-purple)
](#[link to your badge 3])

[GitHub Repository](#[link to your GitHub repo]) | [Documentation (Coming Soon)](#[link to your docs]) | Examples

</div>

👋 Welcome!

Your Project Name brings the power of AI to kids' devices with a specially fine-tuned LLaMA model for engaging, age-appropriate language. Experience fast, private language model inference directly in your web browser, accelerated by WebGPU.
...
<br>
<em>See how Your Project Name makes AI fun and accessible for kids.</em>
</div>
...
const selectedModel = "KidFriendly-LLaMA-7B-Instruct-YOURPROJECT"; // Your model identifier

const engine = await CreateYourEngine(selectedModel);
...
Your Project Name is proudly built upon the foundation of the open-source WebLLM project. We leverage their high-performance in-browser LLM inference engine to run our fine-tuned LLaMA model for kids.
...
```
uding Llama 3, Phi 3, Gemma, Mistral, Qwen(通义千问), and many others, making it versatile for various AI tasks. For the complete supported model list, check [MLC Models](https://mlc.ai/models).
